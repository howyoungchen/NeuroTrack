...
NeuroTrack 不是只从产品设想出发，而是在长期、真实的使用中一点点长成的。

- **来自亲身经历。** 我既是开发者，也是一名焦虑症患者，并且长期用 NeuroTrack 记录自己的压力。产品里的取舍来自日常使用，而不只是偶尔测试。
- **问题为焦虑与神经症体验认真设计。** 每周回顾避免生硬的标签、冒犯性的措辞和居高临下的评判，用具体、温和的问题，更贴近焦虑与相关神经症人群的感受。
- **简单、好上手，也足够透明。** 界面保持克制，打开就知道怎么用；代码开源、可供审查，敏感记录默认只留在设备上。
